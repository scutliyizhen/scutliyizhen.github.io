...
<table>
    ...
    <tbody>
        <tr>
            <td>![](https://github.com/scutliyizhen/scutliyizhen.github.io/blob/master/Resources/Posts/liyizhen_blog_cross_platform_old.png)</td>
            <td>String</td>
            <td>包含这个符号的文件的路径</td>
        </tr>
        <tr>
...
Hybrid架构图|混合开发通信逻辑架构|备注    
--|:--:|--:      
打哈哈|![](https://github.com/scutliyizhen/scutliyizhen.github.io/blob/master/Resources/Posts/liyizhen_blog_cross_platform_old.png)|架构情况     

图1.1

上面的Hybrid架构图是我2017年刚进公司的时候在公司的wiki上翻到的，对应的基础库代码也就是早期的WebAppKit。  
